...
def four_four_two(x):
    ...
    formation = [
        ...
        #
        np.array([5, 3]),  # Center Back Left
        np.array([5, -3]),  # Center Back Right
        #
        np.array([3, 5]),  # Center Midfielder Left
        np.array([3, -5]),  # Center Midfielder Right
        #
...
def three_four_three(x):
    ...
    formation = [
        np.array([-13, 0]),  # Goalkeeper
        #
        np.array([-4, 3]),  # Left Defender
        np.array([-6, 6]),  # Center Back Left
        np.array([-4, -3]),  # Right Defender
        #
        #
        ...
        #
        np.array([4, 4]),  # Forward Left
        np.array([4, -4]),  # Forward Right
        np.array([6, 0]),  # Center Back Right
    ]
    for pos in formation:
        pos[0] += x
    return formation
...
def five_four_one():
    formation = [
        ...
        #
        np.array([-4, 4]),  # Left Midfielder
        np.array([-4, -4]),  # Right Midfielder
        #
